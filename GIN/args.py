...
def parser_loader():
    ...
    parser.add_argument('--accumulation-n', default=ed('GRAD_ACCUMULATION_N', 9), type=int,
    ...
    parser.add_argument('--warmup_steps', default=ed('WARMUP_STEPS', 1), type=int, help='if 0, completely one shot')
