...
def run_get_mask(args):
    ...
    #teacher model
    teacher_model = net_gat.GATNet(args['embedding_dim'], g, args['device'], spar_wei=False, spar_adj=False, coef=args['coef'])
    ...
    pretrain=args['pretrain_epoch'],
        ...
        if epoch >= args['pretrain_epoch'] and epoch <args['pretrain_epoch'] + args['total_epoch']:
            if args["spar_adj"]:
                ...
                utils.subgradient_update_mask(pruner,1e-4)
...
if __name__ == "__main__":
    args = parser_loader()
    print(args)
    args['teacher_path'] = 'teacher_model.pth'  # Path to pre-trained teacher
